...
const projectsData = [
  {
    ...
    position: [2, 1, 0],
    color: "#00ffff",
    description: "An event-driven healthcare platform with Spring Boot microservices, Kafka, AI-powered symptom checker, appointment management, and telemedicine capabilities orchestrated via Docker.",
    technologies: ["Spring Boot", "React", "Kafka", "Docker", "PostgreSQL"],
  ...
  },
  {
    ...
    position: [-2, -1, 1],
    color: "#ff00ff",
    description: "A real-time communication app with live video and chat via Next.js and serverless PostgreSQL. Uses OpenAI and Inngest for intelligent background agents that generate automated PDF meeting reports.",
  ...
  },
  {
    ...
    position: [0, 2, -2],
    color: "#ffff00",
    description: "A scalable MERN stack web app for civic participation — featuring issue tracking, community marketplaces, green initiative management, CI/CD with GitHub Actions, and Cloudinary integration.",
  ...
  },
  {
    ...
    position: [-1, 0, 2],
    color: "#00ff00",
    description: "A native Android lifestyle-tracking app in Kotlin combining habit management, mood journaling, custom home screen widgets, automated hydration reminders, and secure user authentication.",
