  ...
  return (
    <section id="contact" className="py-20 relative">
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-6 liquid-gradient font-sora">Reach Out</h2>
          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            Have a project in mind or just want to talk tech? I'm usually reachable.
          </p>
        </motion.div>
            ...
            <Card className="glass-morphism border-white/20">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white/80">vishwamadusanka1022@gmail.com</span>
                </div>

                <div className="flex items-center gap-3">
                  <Phone className="h-5 w-5 text-green-400" />
                  <span className="text-white/80">+94 76 7923 741</span>
                </div>

                <div className="flex items-center gap-3">
                  <MapPin className="h-5 w-5 text-purple-400" />
                  <span className="text-white/80">Bandarawela, Sri Lanka</span>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-white/80 text-sm">
                        Hi! I'm Vishwa's AI assistant. I can help answer questions about his experience,
                        projects, or skills. What would you like to know?
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Badge variant="secondary" className="bg-white/10 text-white cursor-pointer hover:bg-white/20">
                      Tell me about Vishwa's projects
                    </Badge>
                    <Badge variant="secondary" className="bg-white/10 text-white cursor-pointer hover:bg-white/20">
            ...
            <Card className="glass-morphism border-white/20">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { name: "GitHub", icon: "🐙", color: "hover:text-gray-400", href: "https://github.com/vishwa-madusanka" },
                    { name: "LinkedIn", icon: "💼", color: "hover:text-blue-400", href: "#" },
                  ].map((social) => (
                    <motion.a
                      key={social.name}
                      href={social.href}
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-white/60">© 2025 Vishwa Madusanka. Crafted with ❤️ and cutting-edge tech.</div>

            <div className="flex items-center gap-4">
              <div className="w-16 h-1 bg-gradient-to-r from-sky-500 to-amber-400 rounded-full animate-pulse" />
              <span className="text-white/40 text-sm">Built by Vishwa — SLIIT · Sri Lanka</span>
            </div>
          </div>
        </motion.footer>
      </div>
